...
export default function Header() {
    return (
        <header className="w-full h-15 flex justify-between items-center px-5 border-b border-gray-600 bg-primary-background text-light-text">
            ...
            <form action="/search">
                <div className="max-w-3xl border-1 border-gray-600 rounded-lg flex grow shrink overflow-hidden">
                    <input type="text" placeholder="Search for products" className="py-2 px-4 flex grow bg-primary-foreground text-dark-text" />
